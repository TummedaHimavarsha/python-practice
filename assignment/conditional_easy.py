...
print("Chatbot: Hi! I'm PyBot. How can I help you?")
...
while True:
    ...
    elif user in ["i am fine", "fine", "good", "i'm good"]:
        print("Chatbot: Great! How can I assist you today?")
    
    elif "name" in user:
        print("Chatbot: My name is PyBot. I'm a simple chatbot created in Python!")
    
    elif "your age" in user:
        print("Chatbot: I'm always young. I was created just a few seconds ago :)")
    
    elif "help" in user:
        print("Chatbot: Sure! You can ask me about my name, age, or just say hello.")
